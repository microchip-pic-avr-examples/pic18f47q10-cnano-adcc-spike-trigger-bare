...
2. Open the *pic18f47q10-cnano-adcc-spike-trigger-bare.X* project in MPLAB® X IDE.

3. Set *pic18f47q10-cnano-adcc-spike-trigger-bare* project as main project. Right click on the project in the *Projects* tab and click *Set as Main Project*:
...
6. Put a breakpoint inside the ADCC_ThresholdISR() function by clicking the line number. 
